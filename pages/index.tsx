			...
			<footer className='w-full md:h-[30rem] h-[25rem] bg-white relative font-raleway overflow-hidden'>
				<div className='flex justify-between mx-auto w-[80%] md:mt-20 mt-10'>
					<div className='text-notSoBlack md:text-5xl font-extrabold text-3xl text-center w-full md:w-auto md:text-left'>
						...
						<h2 className=''>Send me a
							<span className='group text-mygreen cursor-pointer relative z-10'> message.
								<div className='bg-mygreen h-[0.25rem] absolute bottom-0 left-0 group-hover:w-[95%] w-0 mx-auto transition-all ease-in-out duration-500 origin-center ml-3 z-[-2] md:block hidden'>
								</div>
								<div className='bg-white w-10 h-full absolute right-[2.35rem] z-[-1] top-5 md:block hidden'></div>
							</span>
						</h2>
					</div>
					<div className='relative items-center h-fit text-3xl font-bold text-notSoBlack cursor-pointer w-fit md:flex hidden'>
						<p className='peer'>Top</p>
						...
						<CgArrowLongUp className='rotate-180 peer-hover:rotate-0 transition-all ease-in-out duration-500 opacity-0 peer-hover:opacity-100' />
					</div>
				</div>
