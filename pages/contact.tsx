                        ...
                        <div className='text-lightBorder lg:ml-2 font-quicksand'>
                            <div className='mt-12 lg:w-[21rem] w-[18rem]'>
                                <motion.div initial={{ y: 100, opacity: 0 }} animate={{ y: 0, opacity: 100 }} transition={{ duration: 1, delay: 0.2 }} className='relative'>
                                    <input name="email" id="email" className='peer w-full bg-transparent border-b-[3px] border-b-lightBorder outline-0 p-2' autoComplete='off' onChange={handleChangeEmail} value={message['email' as keyof messageProp]} onFocus={() => { onFocusMessage("email") }} onBlur={() => { onBlurMessage('email') }}></input>
                                ...
                                <motion.div initial={{ y: 100, opacity: 0 }} animate={{ y: 0, opacity: 100 }} transition={{ duration: 1, delay: 0.25 }} className='relative mt-10'>
                                    <TextareaAutosize className='peer w-full resize-none bg-transparent border-b-[3px] border-b-lightBorder outline-0 p-2' name="message" maxRows={2} id="message" onChange={handleChangeMessage} value={message['message' as keyof messageProp]} onFocus={() => { onFocusMessage('message') }} onBlur={() => { onBlurMessage('message') }} />
