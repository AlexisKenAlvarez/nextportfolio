            ...
            <div className='flex justify-between mx-auto w-[80%] md:mt-20 mt-10'>
                <div className='text-notSoBlack dark:text-white md:text-5xl font-extrabold text-3xl text-center w-full md:w-auto md:text-left'>
                    <div className='relative md:pb-2 pb-1 w-fit mx-auto md:mx-0 overflow-hidden'>
                        ...
                        <motion.div ref={sendRef} variants={variants} initial="initialLeft" animate={sendView ? "animateLeft" : "none"} className='absolute w-full h-full bg-mygreen dark:bg-lightg top-0 z-10'></motion.div>
                ...
                <div className='relative items-center h-fit text-3xl font-bold text-notSoBlack dark:text-white w-fit md:flex hidden overflow-hidden pb-4'>
                    ...
                    <div className='bg-mygreen dark:bg-lightg peer-hover:w-[4.8rem] h-[0.2rem] absolute bottom-2 mx-auto left-auto right-auto w-0 transition-all ease-in-out duration-500 origin-center'></div>
                    ...
                    <motion.div ref={isRef} variants={variants} initial="initialRight" animate={isView ? "animateRight" : "none"} className='absolute w-full h-full bg-mygreen dark:bg-lightg top-0 z-10'></motion.div>
            ...
            <div className='flex md:justify-between mx-auto w-[80%] absolute lg:bottom-10 left-0 right-0 h-fit bottom-20 flex-col md:flex-row items-center md:items-start'>
                <div className='flex items-center w-fit cursor-pointer mb-10 md:mb-0'>
                    <div className="relative overflow-hidden">
                        ...
                        <motion.div ref={logoRef} variants={variants} initial="initialLeft" animate={logoView ? "animateLeft" : "none"} className='absolute w-full h-full bg-mygreen dark:bg-lightg top-0 z-10'></motion.div>
                    </div>

                </div>
                <div className='self-end relative mx-auto md:mx-0 overflow-hidden'>
                    <motion.p initial={{ opacity: 0 }} animate={copyView ? { opacity: 100 } : {}} transition={{ delay: 0.9 }} className='font-quicksand text-center md:text-left text-sm md:text-md w-full md:w-fit dark:text-white'>© 2023 | Made with ❤ by Alexis Ken Alvarez</motion.p>
                    <motion.div ref={copyRef} variants={variants} initial="initialRight" animate={copyView ? "animateRight" : "none"} className='absolute w-full h-full bg-mygreen dark:bg-lightg top-0 z-10'></motion.div>
