...
const Welcome = () => {
    ...
    return (
        <motion.div transition={{ height: { ease: [.21,1.03,.25,.92], delay: 0.8, duration: 2 } }} initial={false} animate={{ opacity: 1 }} exit={{ height: 0, top: 0 }} className="fixed w-full bg-white z-30 h-screen bg-fixed bottom-0">
