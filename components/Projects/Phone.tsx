    ...
    return (
        <div className='w-full 2xl:h-[24.3rem] bg-white relative h-[22rem] dark:bg-black smooth'>
            <div className="w-full flex md:max-w-[65vw] mx-auto h-full relative px-8 items-center">
                ...
                <Image src={`/Projects/${phone}`} alt="Phone" width="1100" height="1100" unoptimized={true} className="object-contain absolute w-[18rem] 2xl:w-[19.5rem] bottom-0 right-0 hidden lg:block mb-0"></Image>
            </div>
        </div>
    );
}
